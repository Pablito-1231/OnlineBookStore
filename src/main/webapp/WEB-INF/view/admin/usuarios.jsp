<%@ page contentType="text/html;charset=UTF-8" %>
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <%@ include file="layouts/head-redesign.jsp" %>
            <i class="fas ${messageType eq 'success' ? 'fa-check-circle' : 'fa-exclamation-circle'}"></i>
            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <span style="color: var(--text-light); font-style: italic;">Sin
                                                    perfil</span>
                                            </c:otherwise>
                                        </c:choose>
                                    </td>
                                    ...
                                    <td>
                                        <span class="badge ${u.enabled ? 'badge-success' : 'badge-warning'}">
